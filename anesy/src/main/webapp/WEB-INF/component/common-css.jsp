...
<link href="<%=request.getContextPath() %>/resources/lib/bootstrap/css/bootstrap-grid.min.css" rel="stylesheet" type="text/css" media="all">
...
<link href="<%=request.getContextPath() %>/resources/main/css/main.css"" rel="stylesheet" type="text/css" media="all">
